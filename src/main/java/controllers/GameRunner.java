...
public class GameRunner {
	...
	/**
	 * Game Setup -- handles the Setup phase.
	 * All the Setup phase commands and army distribution logic is here.
	 */
	...
	/**
	 * The Game Loop method: handles all the logic for processing turns.
	 * Reading and executing commands for REINFORCE, ATTACK (TODO), and FORTIFY phases.
	 */
