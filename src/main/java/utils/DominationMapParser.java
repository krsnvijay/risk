...
public class DominationMapParser implements MapParser {
   ...
   */
  private Country deserializeCountry(String countryLine, ArrayList<String> continentNames) {
   ...
   */
  private Map.Entry<String, Set<String>> deserializeBorder(
   ...
   */
  private String serializeCountry(
